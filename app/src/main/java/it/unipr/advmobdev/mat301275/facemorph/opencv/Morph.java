...
public class Morph {
    ...
    public static void applyAffineTransform(Mat warpImage, Mat src, MatOfPoint2f srcTri, MatOfPoint2f dstTri) {
        ...
        //Log.i("PixellowarpImage", String.valueOf(warpImage.get(0,0)[0]) + " " + String.valueOf(warpImage.get(0,0)[1]) + " " + String.valueOf(warpImage.get(0,0)[2]));
        //Log.i("PixelloWarpMat", String.valueOf(warpMat.get(0,0)[0]) + " " + String.valueOf(warpMat.get(0,0)[1]) + " " + String.valueOf(warpMat.get(0,0)[2]));
        //Log.i("PixelloSrcTri", String.valueOf(srcTri.get(0,0)[0]) + " " + String.valueOf(srcTri.get(0,0)[1]) + " " + String.valueOf(srcTri.get(0,0)[2]));
        //Log.i("PixelloDstTri", String.valueOf(dstTri.get(0,0)[0]) + " " + String.valueOf(dstTri.get(0,0)[1]) + " " + String.valueOf(dstTri.get(0,0)[2]));
    ...
    public static Bitmap getMorph(double alpha, Context context) throws IOException {
        ...
        Mat imgMorph = new Mat(img1.size(), CvType.CV_32FC3);
